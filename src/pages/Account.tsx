    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="bg-gray-800 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-white">{userStats.booksRead}</p>
        </div>
        <div className="bg-gray-800 rounded-lg p-4">
          <div className="flex items-center gap-2 text-gray-400 mb-2">
          ...
          <p className="text-2xl font-bold text-white">{userStats.readingStreak} days</p>
        </div>
        <div className="bg-gray-800 rounded-lg p-4">
          <div className="flex items-center gap-2 text-gray-400 mb-2">
          ...
          <p className="text-2xl font-bold text-white">{userStats.totalReadingTime}</p>
        </div>
      </div>
